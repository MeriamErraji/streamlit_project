...
if page == "Accueil":
    st.image("/Users/Meriam/Desktop/M2.IEF/S2.IEF/Risque_et_Performance/projet_RisquePerformances/resultats_analyses/Davoust Patrimoine.png", use_container_width=True)
